...
$_['text_success']     		= 'Klart: Dina ändringar i fraktmodulen United States Postal Service är utförda!';
$_['text_edit']             = 'Redigera United States Postal Service';
...
$_['text_large']            = 'Large';
$_['text_rectangular']      = 'Rektangulär';
$_['text_non_rectangular']  = 'Inte rektangulär';
$_['text_variable']         = 'Variabel';

// Entry
$_['entry_user_id']         = 'Användar-ID';
$_['entry_postcode']        = 'Zip-kod';
$_['entry_domestic']        = 'Nationella tjänster';
$_['entry_international']   = 'Internationella tjänster';
$_['entry_size']            = 'Storlek';
$_['entry_container']       = 'Etikett';
$_['entry_machinable']      = 'Maskinbearbetningsbar';
$_['entry_dimension']       = 'Dimensioner (L x B x H)';
$_['entry_length']          = 'Längd';
$_['entry_height']          = 'Höjd';
$_['entry_width']           = 'Bredd';
$_['entry_display_time']    = 'Visa leveranstid';
$_['entry_display_weight']  = 'Visa fraktvikt';
$_['entry_weight_class']    = 'Viktklass';
$_['entry_tax']             = 'Skatteklass';
...
// Help
$_['help_dimension']        = 'Genomsnittliga emballage storlek. Individuella artikel stöds inte när denna används';
$_['help_display_time']     = 'Vill du visa sändningstiden? (exempelvis: Skickas inom 3 till 5 dagar)';
$_['help_display_weight']   = 'Vill du visa fraktvikten? (exempelvis Leveransvikt: 2,7674 kg)';
$_['help_weight_class']     = 'Måste ställas in på pounds.';
$_['help_debug']      		= 'Sparar sända/ta emot data till systemloggen';

// Error
$_['error_permission']      = 'Varning: Du har inte behörighet att ändra i fraktmodulen United States Postal Service';
$_['error_user_id']         = 'Användar-ID krävs!';
$_['error_postcode']        = 'Zip/Postnummer krävs!';
$_['error_width']        	= 'Bredd krävs!';
$_['error_length']        	= 'Längd krävs!';
$_['error_height']        	= 'Höjd krävs!';
$_['error_girth']        	= 'Omkrets krävs!';